  ...
  return (
    <>
      <div className="text-center flex flex-col items-center justify-center  md:p-20 mx-auto">
        ...
        <h1 className="text-2xl lg:text-4xl font-bold tracking-wider text-black mb-4">
          EMBARK ON THRILLING HORIZONS WITH ADVENTURES!
        </h1>
        <h3 className="text-lg lg:text-2xl w-3/5 font-medium  text-slate-500 mb-2">
      ...
      <div className={poppins.className}>
        <div className="flex-row justify-center items-center text-center ">
          ...
          <div className="text-center flex flex-col items-center justify-center md:p-20 mx-auto w-4/5 md:w-3/5">
            ...
            <div className={josefinSans.className}>
              ...
              <h3 className="text-lg lg:text-2xl font-medium text-slate-500 mb-2">
                Explore, Connect, and Embark on Adventures Together with Yoliday
              </h3>
            </div>
          </div>
        ...
        <div className="bg-[#FFF3F2] flex flex-col lg:flex-row md:flex-col md:flex-row w-screen lg:p-12 items-center ">
          <Image
            src={groupimg}
            className="lg:pl-10 lg:w-1/2 md:w-1/1"
            alt="Home Background"
          />
          <div className=" lg:w-1/2 md:w-1/1  p-5 text-center lg:text-left">
            <h2 className="text-xl lg:text-3xl font-extrabold tracking-wider text-orange-500 mb-4 font-poppins">
              JOIN YOLIDAY EXPERIENCES
            </h2>

            <h1 className="text-4xl lg:text-4xl font-bold tracking-wider flex flex-col space-y-8 text-black mb-4">
              WHERE MEMORIES BLOOM LED BY YOUR TRIBE
            </h1>
        ...
        >
          ...
          <div className="mb-[70vh] sm:mb-0 lg:w-2/3 md:w-2/3 p-10 lg:pt-[15vh] ">
            <h1 className="text-4xl lg:text-4xl font-bold tracking-widest text-white mb-4 p-2">
            ...
            <form className="my-5">
              <div className="relative flex items-stretch lg:w-1/2 ">
                ...
                <svg
                  ...
                  strokeWidth={2}
                  stroke="orange"
                  className="lg:w-[5vh] lg:h-[5vh] w-[3vh] h-[3vh] absolute mt-2   ml-4 "
                >
                  <path
                    strokeLinecap="round"
