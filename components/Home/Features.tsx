...
export default function Features() {
  const data = [
    ...
    },
    {
      ...
      paragraph: "Your next adventure awaits you. Let's get set go & make the best memories!",
    },
    {
      imageUrl: c2,
      heading: "Connect with Like-Minded Travelers",
      paragraph: "Join forces with like-minded adventurers and unlock a world of shared experiences1",
    },
    {
      imageUrl: c2,
      heading: "Easy Experience Sharing",
      paragraph: "It's as easy as a bee, hop in and read some of the finest trip tips and tricks.",
    },
    {
      imageUrl: c2,
      heading: "Join Yoliday-Curated Experiences",
      paragraph: "Ditch the boring itinerary and join in unique travel experiences.",
    },
    {
      imageUrl: c2,
      heading: "Event Notifications for you",
      paragraph: "Miss on nothing with our customized event notifications for you.",
    },
  ];
  return (
    <>
      <div className="text-center flex flex-col items-center justify-center  p-20 mx-auto">
        <h2 className="text-xl lg:text-3xl font-extrabold tracking-wider text-orange-500 mb-4 font-poppins">
          KEY FEATURES
        </h2>

        <h1 className="text-4xl lg:text-6xl font-bold tracking-wider text-black mb-4">
          DISCOVER, SHARE, AND JOURNEY TOGETHER IN THE ULTIMATE TRAVEL COMMUNITY
        </h1>

        <h3 className="text-lg lg:text-3xl w-3/5 font-light text-black mb-2">
      ...
      <div className="flex flex-col lg:flex-row md:flex-row w-screen lg:p-12 items-center">
        <Image src={phone} className="lg:pl-10 lg:w-[90vh] md:w-1/2" alt="Home Background" />
        <Carousel
          opts={{
            align: "start",
          }}
          ...
          <CarouselContent>
            {data.map((item, index) => (
              <CarouselItem key={index} className=" md:basis-2/3 lg:basis-2/5">
                <div className="p-5">
                  <Card className="card transition duration-300 transform hover:drop-shadow-2xl ">
